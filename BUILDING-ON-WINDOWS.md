...
1. Download the ZIP (log into GitHub if asked):
   https://github.com/Forgotten-Mu3z/mu3z-macro/archive/refs/heads/claude/tender-hamilton-nyl3cm.zip
...
3. The mod is `build\libs\altartestclient-1.0.0.jar` (ignore the `-sources.jar`).
